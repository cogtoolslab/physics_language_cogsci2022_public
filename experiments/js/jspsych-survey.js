 ...
 jsPsych.plugins['survey'] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      if(trial.preamble !== null){
        html += '<div id="jspsych-survey-preamble" class="jspsych-survey-preamble">'+trial.preamble+'</div>';
      }
      // start form
      if ( trial.autocomplete ) {
        html += '<form id="jspsych-survey">'
      } else {
        html += '<form id="jspsych-survey" autocomplete="off">'
      }
      ...
      // add submit button
      html += '<input type="submit" id="jspsych-survey-next" class="jspsych-btn jspsych-survey" value="'+trial.button_label+'"></input>';
      ...
      display_element.querySelector('#jspsych-survey').addEventListener('submit', function(event) {
        // don't submit form
