 ...
 */
 ...
 jsPsych.plugins['survey-html-form'] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      // var textCounter = function textCounter(obj){
      //   document.getElementById("charNum").innerHTML = obj.value.length+' characters';
      // };

      // var textarea = display_element.querySelector('#jspsych-survey-html-form').querySelector('textarea'); 
      // textarea.addEventListener("keyup", function (e){
      //   textCounter(textarea);
      // });

      var wrapper = document.createElement('div');
      var text    = display_element.querySelector('#jspsych-survey-html-form').querySelector('textarea');
      ...
      function _set() {
        c_wrap.style.left = (text.clientWidth - c_wrap.clientWidth - 2) + 'px';
